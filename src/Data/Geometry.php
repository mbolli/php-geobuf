...
class Geometry extends Message implements IHasCustomProperties {
     ...
     *
     *     @var int $type
     *     @var int[]|RepeatedField $lengths
     *           coordinate structure in lengths
     *     @var int[]|RepeatedField|string[] $coords
     *           delta-encoded integer values
     *     @var Geometry[]|RepeatedField $geometries
    ...
    public function setGeometries($var) {
        $arr = GPBUtil::checkRepeatedField($var, GPBType::MESSAGE, self::class);
        $this->geometries = $arr;
